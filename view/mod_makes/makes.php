	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">Página de marcas</li>
			</ol>
		</div>
	</div>
<!-- //breadcrumbs -->
		...
		<h2>Marcas</h2>
			<div class="grid_3 grid_5">
				<div class="snipcart-details top_brand_home_details">
					<form method="post">
						<fieldset>
							<input type="submit" name="btnmake" value="Registrar nueva marca" class="new_product button" />
							<?php 
								if (isset($_POST['btnmake'])) {
									echo "<script type='text/javascript'>";
									echo "window.location.replace('add_make.php');";
									echo "</script>";
								}
							 ?>
						</fieldset>
												...
												<figure>
													<div class="snipcart-item block" >
														<div class="snipcart-thumb">
															<img align='middle' src='../downloadImageMake.php?id_marca=<?=$row['id_marca']?>' width='60%' >
															<p><?=$row['nombre']?></p>
														</div>
														<div class="snipcart-details top_brand_home_details">
															<a href="../downloadVideoMake.php?id_marca=<?=$row['id_marca']?>" target="_blank"><span class="glyphicon glyphicon-film"></span></a>
															<a href="../downloadDocumentMake.php?id_marca=<?=$row['id_marca']?>" target="_blank"><span class="glyphicon glyphicon-file"></span></a>
														</div>
														<div class="snipcart-details top_brand_home_details">
															<a href="read_make.php?id_marca=<?=$row['id_marca']?>" ><span class="glyphicon glyphicon-zoom-in"></span></a>
															<a href="update_make.php?id_marca=<?=$row['id_marca']?>" ><span class="glyphicon glyphicon-pencil"></span></a>
															<a href="delete_make.php?id_marca=<?=$row['id_marca']?>" ><span class="glyphicon glyphicon-trash"></span></a>
														</div>
													</div>
												</figure>
											</div>
