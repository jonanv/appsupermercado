	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">Página de clientes</li>
			</ol>
		</div>
	</div>
<!-- //breadcrumbs -->
								...
								<table class="list">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<a href="read_client.php?cedula=<?=$row['cedula']?>" ><span class="glyphicon glyphicon-zoom-in"></span></a>
											</td>
											<td>
												<a href="update_client.php?cedula=<?=$row['cedula']?>" ><span class="glyphicon glyphicon-pencil"></span></a>
											</td>
											<td>
												<a href="delete_client.php?cedula=<?=$row['cedula']?>" ><span class="glyphicon glyphicon-trash"></span></a>
											</td>
										</tr>
										<?php 
											}
