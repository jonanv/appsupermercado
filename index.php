...
<?php 
	session_start();
	if (isset($_SESSION['cor_Usuario']) && isset($_SESSION['nom_Usuario'])) {
		echo "<script type='text/javascript'>";
		echo "window.location.replace('view/menuppal.php')";
		echo "</script>";
	}
 ?>
<!DOCTYPE html>
	...
	<div class="agileits_header">
		<div class="container">
			<div class="agile-login session">
				<ul>
					<li><a href="view/registered.php">Registrarse</a></li>
			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav">
						...
						<!-- Mega Menu -->
						<li class="active"><a href="view/buscar_marca.php" class="act">Buscar por marca</a></li>
					</ul>
				</div>
			</nav>
		</div>
												...
												<figure>
													<div class="snipcart-item block" >
														<div class="snipcart-thumb">
															<img align='middle' src='view/downloadImageProduct.php?id_producto=<?=$row['id_producto']?>' >
															<p><?=$row['nombre']?></p>
															<div class="stars">
			...
			<div class="brands-agile">
				...
				<div class="col-md-2 w3layouts-brand">
					<div class="make brands-w3l">
						<p><a href="#"><img src="view/downloadImageMake.php?id_marca=<?=$row['id_marca']?>" width="100%"></a></p>
					</div>
				</div>
				<?php 
					}
