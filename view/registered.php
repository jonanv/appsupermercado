		...
		<div class="container">
			...
			<div class="login-form-grids">
				...
				<form action="#" method="post">
					...
					<input type="submit" name="btnregistred" value="Registrarse">
				</form>
				<?php 
					//Abrir la conexión
					...
					if (isset($_POST['btnregistred'])) {
						...
						$sql = "INSERT INTO cliente(cedula, nombre, apellido, direccion, telefono, correo, contrasena, activo) VALUES($cedula, '$nombre', '$apellido', '$direccion', '$telefono', '$correo', '$contrasena', '$activo')";

						if (!pg_query($conexion, $sql)){
							echo "<script type='text/javascript'>";
							echo "alert('No se pudo insertar datos del cliente...');";
							echo "</script>";
						}
						else{
							echo "<script type='text/javascript'>";
							echo "alert('Cliente ingresado con éxito!');";
