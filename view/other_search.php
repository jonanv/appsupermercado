	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">Página de otra búsqueda</li>
			</ol>
		</div>
	</div>
<!-- //breadcrumbs -->
		...
		<div class="container">
			<div class="other_search">
				...
				<form method="post">
					...
					<select name="menor_mayor" required>
						<option></option>
					...
					<label>a</label>
					<input type="number" placeholder="Precio" name="precio_venta" required >

					<input type="submit" name="btnsearch1" value="Buscar">
				</form>
				<!--Búsqueda 2-->
				<form method="post">
					...
					<input type="submit" name="btnsearch2" value="Buscar">
				</form>
				<!--Búsqueda 3-->
