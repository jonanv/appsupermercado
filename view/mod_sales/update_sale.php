	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">Página de modificar venta</li>
			</ol>
		</div>
	</div>
<!-- //breadcrumbs -->
<!-- register -->
		...
		<div class="container">
			...
			<div class="login-form-grids">
				...
				<form method="post" enctype="multipart/form-data">
					...
					<input type="submit" name="btnupdate" value="Modificar venta">
				</form>
				<?php 
					}
					//Cerrar la conexión
				...
				<table class="list">
					...
					<tbody>
						...
						<tr>
							...
							<td><?=$row['valor']?></td>
							<td>
								<a href="update_detailsale.php?id_factura_venta=<?=$row['id_factura_venta']?>&id_producto=<?=$row['id_producto']?>" ><span class="glyphicon glyphicon-pencil"></span></a>
							</td>
							<td>
								<a href="delete_detailsale.php?id_factura_venta=<?=$row['id_factura_venta']?>&id_producto=<?=$row['id_producto']?>&cantidad=<?=$row['cantidad']?>" ><span class="glyphicon glyphicon-trash"></span></a>
							</td>
						</tr>
						<?php 
							}
	...
	<?php 
		...
		if (isset($_POST['btnupdate'])) {
			...
			$sql = "UPDATE factura_venta SET id_empleado = '$id_empleado', cedula = '$cedula', fecha_venta = '$fecha_venta' WHERE id_factura_venta = $id_factura_venta";
			$result = pg_query($conexion, $sql);
	 ?>
