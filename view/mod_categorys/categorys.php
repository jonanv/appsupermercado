	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">Página de categorías</li>
			</ol>
		</div>
	</div>
<!-- //breadcrumbs -->
		...
		<h2>Categorías</h2>
			<div class="grid_3 grid_5">
				<div class="snipcart-details top_brand_home_details">
					<form method="post">
						<fieldset>
							<input type="submit" name="btncategoria" value="Registrar nueva categoría" class="new_product button" />
							<?php 
								if (isset($_POST['btncategoria'])) {
									echo "<script type='text/javascript'>";
									echo "window.location.replace('add_category.php');";
									echo "</script>";
								}
							 ?>
						</fieldset>
								...
								<table class="list">
									...
									<tbody>
										...
										<tr>
											<td><?=$row['nombre']?></td>
											<td>
												<a href="read_category.php?id_categoria=<?=$row['id_categoria']?>" ><span class="glyphicon glyphicon-zoom-in"></span></a>
											</td>
											<td>
												<a href="update_category.php?id_categoria=<?=$row['id_categoria']?>" ><span class="glyphicon glyphicon-pencil"></span></a>
											</td>
											<td>
												<a href="delete_category.php?id_categoria=<?=$row['id_categoria']?>" ><span class="glyphicon glyphicon-trash"></span></a>
											</td>
										</tr>
										<?php 
											}
