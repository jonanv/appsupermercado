	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">Página de modificar proveedor</li>
			</ol>
		</div>
	</div>
<!-- //breadcrumbs -->
<!-- register -->
	<div class="register">
		<div class="container">
			<h2>Modificar proveedor aquí</h2>
			<div class="login-form-grids">
				...
				<form method="post" enctype="multipart/form-data">
					<input type="text" placeholder="Nit" name="nit" value="<?=$row['nit']?>" readonly >
					...
					<input type="submit" name="btnupdate" value="Modificar proveedor">
				</form>
				<?php 
					}
					//Cerrar la conexión
	...
	<?php 
		...
		if (isset($_POST['btnupdate'])) {
			...
			$sql = "UPDATE proveedor SET nombre = '$nombre', apellido = '$apellido', direccion = '$direccion', telefono = '$telefono', correo = '$correo' WHERE nit = $nit";
			$result = mysqli_query($link, $sql);

			if (!pg_query($conexion, $sql)){
				echo "<script type='text/javascript'>";
				echo "alert('No se pudo modificar datos del proveedor...');";
				echo "</script>";
			}
			else{
				echo "<script type='text/javascript'>";
				echo "alert('Proveedor modificado con éxito!');";
