	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">Página de eliminar cliente</li>
			</ol>
		</div>
	</div>
<!-- //breadcrumbs -->
		...
		<div class="container">
			...
			<div class="login-form-grids">
				...
				<form method="post" enctype="multipart/form-data">
					<input type="text" placeholder="Cedula" name="cedula" value="<?=$row['cedula']?>" readonly >
					...
					<input type="submit" name="btndelete" value="Eliminar cliente">
				</form>
				<?php 
						}
					}
		...
		if (isset($_POST['btndelete'])) {
			if ($_REQUEST['cedula']) {
				...
				if (!$result){
					...
					echo "alert('Cliente eliminado con éxito');";
