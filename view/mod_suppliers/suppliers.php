	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">Página de proveedores</li>
			</ol>
		</div>
	</div>
<!-- //breadcrumbs -->
		...
		<h2>Proveedores</h2>
			<div class="grid_3 grid_5">
				<div class="snipcart-details top_brand_home_details">
					<form method="post">
						<fieldset>
							<input type="submit" name="btnproveedor" value="Registrar nuevo proveedor" class="new_product button" />
							<?php 
								if (isset($_POST['btnproveedor'])) {
									echo "<script type='text/javascript'>";
									echo "window.location.replace('add_supplier.php');";
									echo "</script>";
								}
							 ?>
						</fieldset>
								...
								<table class="list">
									...
									<tbody>
										...
										<tr>
											...
											<td><?=$row['correo']?></td>
											<td>
												<a href="read_supplier.php?nit=<?=$row['nit']?>" ><span class="glyphicon glyphicon-zoom-in"></span></a>
											</td>
											<td>
												<a href="update_supplier.php?nit=<?=$row['nit']?>" ><span class="glyphicon glyphicon-pencil"></span></a>
											</td>
											<td>
												<a href="delete_supplier.php?nit=<?=$row['nit']?>" ><span class="glyphicon glyphicon-trash"></span></a>
											</td>
										</tr>
										<?php 
											}
