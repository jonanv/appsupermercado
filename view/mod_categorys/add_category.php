	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">Página de registrar nueva categoría</li>
			</ol>
		</div>
	</div>
<!-- //breadcrumbs -->
<!-- register -->
	<div class="register">
		<div class="container">
			<h2>Registrar categoría aquí</h2>
			<div class="login-form-grids">
				<h5>Información de la categoría</h5>
				<form method="post" enctype="multipart/form-data">
					<input type="text" placeholder="Nombre" name="nombre" required >
					
					<input type="submit" name="btnregistred" value="Registrar categoría">
				</form>
				<?php 
					//Abrir la conexión
					...
					if (isset($_POST['btnregistred'])) {
						...
						if (!pg_query($conexion, $sql)){
							...
							echo "alert('No se pudo insertar datos de la categoria...');";
							echo "</script>";
						}
						else{
							echo "<script type='text/javascript'>";
							echo "alert('Categoría ingresada con éxito!');";
