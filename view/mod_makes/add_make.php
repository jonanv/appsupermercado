	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">Página de registrar nueva marca</li>
			</ol>
		</div>
	</div>
<!-- //breadcrumbs -->
		...
		<div class="container">
			...
			<div class="login-form-grids">
				...
				<form method="post" enctype="multipart/form-data">
					...
					<input type="file" placeholder="Video" name="video" required >
					<input type="file" placeholder="Documento" name="documento" required >
					
					<input type="submit" name="btnregistred" value="Registrar marca">
				</form>
				<?php 
					//Abrir la conexión
					...
					if (isset($_POST['btnregistred'])) {
						...
						*/
						...
						$sql = "INSERT INTO marca(nombre, imagen, video, documento) VALUES('$nombre', '{$imagen}', '{$video}', '{$documento}')";

						if (!pg_query($conexion, $sql)){
							echo "<script type='text/javascript'>";
							echo "alert('No se pudo insertar datos de la marca...');";
							echo "</script>";
						}
						else{
							echo "<script type='text/javascript'>";
							echo "alert('Marca ingresada con éxito!');";
