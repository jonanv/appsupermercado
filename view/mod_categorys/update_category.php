	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">Página de modificar categoría</li>
			</ol>
		</div>
	</div>
<!-- //breadcrumbs -->
<!-- register -->
	<div class="register">
		<div class="container">
			<h2>Modificar categoría aquí</h2>
			<div class="login-form-grids">
				...
				<form method="post" enctype="multipart/form-data">
					...
					<input type="submit" name="btnupdate" value="Modificar categoría">
				</form>
				<?php 
					}
					//Cerrar la conexión
	...
	<?php 
		...
		if (isset($_POST['btnupdate'])) {
			...
			if (!pg_query($conexion, $sql)){
				...
				echo "alert('No se pudo modificar datos de la categoría...');";
				echo "</script>";
			}
			else{
				echo "<script type='text/javascript'>";
				echo "alert('Categoría modificada con éxito!');";
