	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">Página de historial de compras</li>
			</ol>
		</div>
	</div>
<!-- //breadcrumbs -->
						...
						<div role="tabpanel" class="tab-pane fade in active" id="expeditions" aria-labelledby="expeditions-tab">
							<div class="agile_top_brands_grids">
								<?php 
									...
									$sql = "SELECT * FROM factura_venta f INNER JOIN cliente c ON f.cedula = c.cedula WHERE c.correo = '$correo'";
								...
								?>
										<table class="list">
											...
											<tbody>
								<?php 
										$sql1 = "SELECT f.id_factura_venta, c.cedula, e.* FROM factura_venta f INNER JOIN cliente c ON f.cedula = c.cedula INNER JOIN empleado e ON e.id_empleado = f.id_empleado WHERE c.correo = '$correo'";
								 ...
								 ?>
								 				<tr>
													...
													<td><?=$row3['total']?></td>
								 					<td>
								 						<a href="shopping_history_detail.php?id_factura_venta=<?=$row['id_factura_venta']?>" ><span class="glyphicon glyphicon-zoom-in"></span></a>
								 					</td>
								 				</tr>
								<?php
										}
