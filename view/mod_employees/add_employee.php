	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">Página de registrar nuevo empleado</li>
			</ol>
		</div>
	</div>
<!-- //breadcrumbs -->
		...
		<div class="container">
			...
			<div class="login-form-grids">
				...
				<form method="post" enctype="multipart/form-data">
					...
					<input type="hidden" placeholder="Activo" name="activo" value="true" >
					<select name="id_permiso" required >
						<option selected="selected">Permiso...</option>
						<?php 
							//Abrir la conexión
							include ("../../configuration/open_conexion.php");
							$sql = "SELECT DISTINCT empleado.id_permiso, permiso.* FROM empleado, permiso WHERE empleado.id_permiso = permiso.id_permiso ORDER BY empleado.id_permiso ASC";
					...
					<input type="submit" name="btnregistred" value="Registrar empleado">
				</form>
				<?php 
					//Abrir la conexión
					include ("../../configuration/open_conexion.php");
					...
					if (isset($_POST['btnregistred'])) {
						...
						$sql = "INSERT INTO empleado(nombre, apellido, direccion, telefono, correo, contrasena, activo, id_permiso) VALUES('$nombre', '$apellido', '$direccion', '$telefono', '$correo', '$contrasena', '$activo', '$id_permiso')";

						if (!pg_query($conexion, $sql)){
							echo "<script type='text/javascript'>";
							echo "alert('No se pudo insertar datos del empleado...');";
							echo "</script>";
						}
						else{
							echo "<script type='text/javascript'>";
							echo "alert('Empleado ingresado con éxito!');";
