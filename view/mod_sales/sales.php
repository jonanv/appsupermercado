						...
						<div role="tabpanel" class="tab-pane fade in active" id="expeditions" aria-labelledby="expeditions-tab">
							<div class="agile_top_brands_grids">
								<?php 
									...
									{
										$sql = "SELECT * FROM factura_venta f INNER JOIN empleado e ON f.id_empleado = e.id_empleado ORDER BY f.id_factura_venta ASC";
										$result = pg_query($conexion, $sql);
										//SELECT f.*, e.*, c.*  FROM factura_venta f INNER JOIN empleado e ON f.id_empleado = e.id_empleado INNER JOIN cliente c ON f.cedula = c.cedula ORDER BY f.id_factura_venta ASC
									}
									else if ($_SESSION['rol_Usuario'] == "Empleado") 
									{
										$correo = $_SESSION['cor_Usuario'];
										$sql = "SELECT * FROM factura_venta f INNER JOIN empleado e ON f.id_empleado = e.id_empleado WHERE e.correo = '$correo' ORDER BY f.id_factura_venta ASC";
										$result = pg_query($conexion, $sql);
									}
								...
								<?php
										...
										if ($_SESSION['rol_Usuario'] == "Administrador") 
										{
											$sql1 = "SELECT * FROM cliente c INNER JOIN factura_venta f ON c.cedula = f.cedula ORDER BY f.id_factura_venta";
											$result1 = pg_query($conexion, $sql1);
										}
										else if ($_SESSION['rol_Usuario'] == "Empleado") 
										{
											$sql1 = "SELECT * FROM cliente c INNER JOIN factura_venta f ON c.cedula = f.cedula WHERE f.id_empleado = (SELECT id_empleado FROM empleado WHERE correo = '$correo') ORDER BY f.id_factura_venta";
											$result1 = pg_query($conexion, $sql1);
										}
