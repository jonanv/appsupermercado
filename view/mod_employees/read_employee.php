	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
				...
				<li class="active">Página de consultar empleado</li>
			</ol>
		</div>
	</div>
<!-- //breadcrumbs -->
		...
		<div class="container">
			...
			<div class="login-form-grids">
				...
				<form method="post" enctype="multipart/form-data">
					...
					<input type="text" placeholder="Apellido" name="apellido" value="<?=$row['apellido']?>" readonly >
					<input type="text" placeholder="Dirección" name="direccion" value="<?=$row['direccion']?>" readonly  >
					<input type="number" placeholder="Télefono" name="telefono" value="<?=$row['telefono']?>" readonly  >
					<input type="email" placeholder="Correo electrónico" name="correo" value="<?=$row['correo']?>" readonly >
					<input type="text" placeholder="Contraseña" name="contrasena" value="<?=$row['contrasena']?>" readonly >
					...
					<select name="id_permiso" disabled >
